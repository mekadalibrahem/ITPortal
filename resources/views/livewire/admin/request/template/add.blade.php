<x-widgets.section title="{{ __('string.request_template.new') }}">
    ...
    <div class="mt-5 sm:mt-8">
        ...
        <x-widgets.step-section show="{{ $step == 2 }}">
            ...
            <div class="sm:col-span-2 mb-3 grid grid-cols-3 gap-2">
                ...
                <select type="text" name="template_step" id="template_step" wire:model="template_step"  wire:change="updateDescription"
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                    @forelse ($insert_step_list as $item)
