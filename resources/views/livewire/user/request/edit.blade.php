    ...
    @if ($data)
        <div class="mt-6 space-y-4">
            ...
            @endforeach
                ...
                @else
                    <div  class="mt-2 bg-blue-100 border border-blue-200 text-md text-blue-800 rounded-lg p-4 dark:bg-blue-800/10 dark:border-blue-900 dark:text-blue-500 font-bold" role="alert" tabindex="-1" aria-labelledby="hs-solid-color-success-label" >
                        {{ __('messages.your request finished  , your can not edit it now') }}
                    </div>
                @endif
