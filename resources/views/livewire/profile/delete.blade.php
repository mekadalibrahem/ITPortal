     ...
     <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
         ...
         <div x-data="{ delete_model: false }">
             <x-button status="danger" type="button" class="flex item-center" x-on:click="delete_model = ! delete_model">
                 <svg class="w-5 h-5 ms-1 me-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                 ...
                 <div class="p-4 md:p-5">
                     <form wire:submit="delete">
                         ...
                         <div class="sm:col-span-2 mb-4">
                             <x-form.label for="password_delete" value='{{ __('string.confirm_password') }}' />
